...
static object *
panel_getmember(char *addr, struct memberlist *mlist, char *name)
{
	object *v;
...
static int
panel_setmember(char *addr, struct memberlist *mlist, char *name, object *v)
{
	register struct memberlist *l;
			...
			switch (l->type) {
				...
				case T_STRING:
					...
					if (v == None) {
						...
						*(char**)addr = strdup(getstringvalue(v));
                    }
					break;
				case T_ACTUATOR:
					if (v == None) {
						*(Actuator**)addr = NULL;
						...
						err_setstr(TypeError, "actuator expected");
						return -1;
					}
					else {
						*(Actuator**)addr = ((actuatorobject *)v)->ob_actuator;
                    }
					break;
				default:
...
static object *
panel_addpanel(panelobject *self, object *args)
{
	if (!getnoarg(args)) {
		return NULL;
    }
...
static object *
panel_endgroup(panelobject *self, object *args)
{
	if (!getnoarg(args)) {
		return NULL;
    }
...
static object *
panel_fixpanel(panelobject *self, object *args)
{
	if (!getnoarg(args)) {
		return NULL;
    }
...
static object *
panel_strwidth(panelobject *self, object *args)
{
	object *v;
	double width;
...
static struct methodlist panel_methods[] = {
	{"addpanel",	(method)panel_addpanel},
	{"endgroup",	(method)panel_endgroup},
	{"fixpanel",	(method)panel_fixpanel},
	{"strwidth",	(method)panel_strwidth},
	{NULL,			NULL}	/* sentinel */
};
...
static object *
panel_getattr(panelobject *p, char *name)
{
	object *v = dictlookup(p->ob_paneldict, name);
...
static int
panel_setattr(panelobject *p, char *name, object *v)
{
	int err;
...
static typeobject Paneltype = {
	...
	0,								/*tp_print*/
	(getattrfunc)panel_getattr,		/*tp_getattr*/
	(setattrfunc)panel_setattr,		/*tp_setattr*/
	0,								/*tp_compare*/
	0,								/*tp_repr*/
};
...
struct memberlist slider_spec[] = {
	...
	{"differentialfactor", 	T_FLOAT,	offsetof(Slider, differentialfactor)},
...
struct memberlist typein_spec[] = {
	/* Note: these should be readonly after the actuator is added to a panel */
...
static object *
actuator_addact(actuatorobject *self, object *args)
{
	Panel *p;
...
static object *
actuator_addsubact(actuatorobject *self, object *args)
{
	Actuator *a;
...
static object *
actuator_delact(actuatorobject *self, object *args)
{
	Panel *p;
...
static object *
actuator_fixact(actuatorobject *self, object *args)
{
	Panel *p;
...
static object *
actuator_tprint(actuatorobject *self, object *args)
{
	object *str;
...
static struct methodlist actuator_methods[] = {
	{"addact",			(method)actuator_addact},
	{"addsubact",		(method)actuator_addsubact},
	{"delact",			(method)actuator_delact},
	{"fixact",			(method)actuator_fixact},
	{"tprint",			(method)actuator_tprint},
	{NULL,				NULL}	/* sentinel */
};

static object *
newactuatorobject(Actuator *act)
{
	actuatorobject *a;
...
static void
actuator_dealloc(actuatorobject *a)
{
...
static object *
actuator_getattr(actuatorobject *a, char *name)
{
...
static int
actuator_setattr(actuatorobject *a, char *name, object *v)
{
	Actuator *act = a->ob_actuator;
	struct userdata *u = (struct userdata *) act->u;
	int err;
...
static int
actuator_compare(actuatorobject *v, actuatorobject *w)
{
...
static typeobject Actuatortype = {
	...
	0,								/*tp_itemsize*/
	/* methods */
	(destructor)actuator_dealloc,	/*tp_dealloc*/
	0,								/*tp_print*/
	(getattrfunc)actuator_getattr,	/*tp_getattr*/
	(setattrfunc)actuator_setattr,	/*tp_setattr*/
	(cmpfunc)actuator_compare,		/*tp_compare*/
	0,								/*tp_repr*/
};
...
static object *
module_mkpanel(object *self, object *args)
{
	if (!getnoarg(args)) {
		return NULL;
    }
...
static object *
module_mkact(object *self, object *args)
{
	object *v;
	Actuator *a;
...
static object *
module_dopanel(object *self, object *args)
{
	Actuator *a;
	object *v, *w;
...
static object *
module_drawpanel(object *self, object *args)
{
	if (!getnoarg(args)) {
		return NULL;
    }
...
static object *
module_needredraw(object *self, object *args)
{
	if (!getnoarg(args)) {
		return NULL;
    }
...
static object *
module_userredraw(object *self, object *args)
{
	short wid;
...
static object *
module_block(object *self, object *args)
{
	int flag;
...
static struct methodlist module_methods[] = {
	{"block",		(method)module_block},
	{"dopanel",		(method)module_dopanel},
	{"drawpanel",	(method)module_drawpanel},
	{"mkpanel",		(method)module_mkpanel},
	{"mkact",		(method)module_mkact},
	{"needredraw",	(method)module_needredraw},
	{"userredraw",	(method)module_userredraw},
	{NULL,			NULL}	/* sentinel */
};
