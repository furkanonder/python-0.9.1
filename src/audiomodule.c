...
static object *
audio_get_ioctl(object *self, object *args, long code)
{
	long x;
...
static object *
audio_set_ioctl(object *self, object *args, long code)
{
	long x;
...
static object *
audio_read(object *self, object *args)
{
	int c, i, n;
	object *v;
	char *s;
...
static object *
audio_write(object *self, object *args)
{
	int n, n2;
	object *v;
...
static object *
audio_amplify(object *self, object *args)
{
	object *v;
	char *s, *t;
	int f1, f2;
...
static object *
audio_reverse(object *self, object *args)
{
	object *v;
	char *s, *t;
	int i, n;
...
static object *
audio_add(object *self, object *args)
{
	object *a, *b, *v;
	char *sa, *sb, *t;
...
of the samples. */
static object *
audio_chr2num(object *self, object *args)
{
	object *v, *w;
	char *s;
	int c, i, n;
...
/* audio.num2chr is the inverse of audio.chr2num. Excess values are clipped. */
static object *
audio_num2chr(object *self, object *args)
{
	object *v, *w;
	char *s;
	int c, i, n;
...
static object *
audio_start_recording(object *self, object *args)
{
	int n;
	object *v;
	char *s;
...
static object *
audio_poll(object *self, object *args)
{
	int n;
...
static object *
audio_wait_recording(object *self, object *args)
{
	object *v;
	int n;
...
static object *
audio_stop_recording(object *self, object *args)
...
static object *
audio_start_playing(object *self, object *args)
{
	object *v;
...
static object *
audio_wait_playing(object *self, object *args)
{
	int n;
...
static object *
audio_stop_playing(object *self, object *args)
{
	int n;
...
static object *
audio_audio_done(object *self, object *args)
{
	if (!getnoarg(args)) {
		return NULL;
    }
